...
void mainImage(out vec4 fragColor, in vec2 fragCoord)
{
    ...
    if (S > 0.0) {
        w01 = dot(vel0, e1) / S / offsetPx;
//        w02 = dot(vel0, e2) / S / offsetPx;
        w03 = dot(vel0, e3) / S / offsetPx;
//        w04 = dot(vel0, e4) / S / offsetPx;
        w05 = dot(vel0, e5) / S / offsetPx;
//        w06 = dot(vel0, e6) / S / offsetPx;
        w07 = dot(vel0, e7) / S / offsetPx;
//        w08 = dot(vel0, e8) / S / offsetPx;
    }
...
//        massOutflow += w08 * I0.r;
    ...
    float massInflow10 = getMassInflow(vel1, e1, I1.r);
    massInflow += massInflow10;
    // inflow of the mass from deltaVel
    // massInflow += getMassInflowDeltaVel(vel1, vel0, e1, I1.r);
...
//    // inflow of the mass from deltaVel
//    // massInflow += getMassInflowDeltaVel(vel2, vel0, e2, I2.r);
//    vec2 newVel20 = getNewVel(vel0, vel2, I0.r, I2.r, e2);


    // point 3
    vec2 vel3 = vec2(I3.g, I3.b);
    float massInflow30 = getMassInflow(vel3, e3, I3.r);
    massInflow += massInflow30;
    // inflow of the mass from deltaVel
    // massInflow += getMassInflowDeltaVel(vel3, vel0, e3, I3.r);
...
//    // inflow of the mass from deltaVel
//    // massInflow += getMassInflowDeltaVel(vel4, vel0, e4, I4.r);
//    vec2 newVel40 = getNewVel(vel0, vel4, I0.r, I4.r, e4);


    // point 5
    vec2 vel5 = vec2(I5.g, I5.b);
    float massInflow50 = getMassInflow(vel5, e5, I5.r);
    massInflow += massInflow50;
    // inflow of the mass from deltaVel
    // massInflow += getMassInflowDeltaVel(vel5, vel0, e5, I5.r);
...
//    // inflow of the mass from deltaVel
//    // massInflow += getMassInflowDeltaVel(vel6, vel0, e6, I6.r);
//    vec2 newVel60 = getNewVel(vel0, vel6, I0.r, I6.r, e6);


    // point 7
    vec2 vel7 = vec2(I7.g, I7.b);
    float massInflow70 = getMassInflow(vel7, e7, I7.r);
    massInflow += massInflow70;
    // inflow of the mass from deltaVel
    // massInflow += getMassInflowDeltaVel(vel7, vel0, e7, I7.r);
...
//    // inflow of the mass from deltaVel
//    // massInflow += getMassInflowDeltaVel(vel8, vel0, e8, I8.r);
